...
const COLOR_PRESETS = [
  { id: 'purple', label: '紫罗兰', gradient: 'from-purple-500 to-cyan-400', emoji: '💜' },
  { id: 'ocean', label: '海洋蓝', gradient: 'from-sky-500 to-cyan-400', emoji: '🌊' },
  { id: 'sunset', label: '日落橙', gradient: 'from-rose-500 to-orange-400', emoji: '🌅' },
  { id: 'forest', label: '森林绿', gradient: 'from-emerald-500 to-green-400', emoji: '🌲' },
  { id: 'lavender', label: '薰衣草', gradient: 'from-violet-500 to-fuchsia-400', emoji: '🌸' },
  { id: 'sakura', label: '樱花粉', gradient: 'from-pink-500 to-rose-400', emoji: '🩷' },
];
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="lg relative w-full max-w-sm animate-slide-up max-h-[85vh] overflow-y-auto" style={{ borderRadius: '24px', padding: '1.25rem' }}>
        <h2 className="text-base font-bold mb-4" style={{ color: 'var(--text-primary)' }}>🎨 外观设置</h2>
